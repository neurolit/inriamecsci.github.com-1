...
grainsControllers.controller('SeedListCtrl', ['$scope', '$http', function ($scope, $http) {
    "use strict";
...
grainsControllers.controller('SeedDetailCtrl', ['$scope', '$routeParams', '$http', function ($scope, $routeParams, $http) {
    "use strict";

...
!function(){"use strict";for(var e,r=["assert","clear","count","debug","dir","dirxml","error","exception","group","groupCollapsed","groupEnd","info","log","markTimeline","profile","profileEnd","table","time","timeEnd","timeStamp","trace","warn"],t=r.length,s=window.console=window.console||{};t>0;)s[e=r[t]]||(s[e]=function(){}),t-=1}();var grainsApp=angular.module("grains",["ngRoute","grainsControllers"]);grainsApp.config(["$routeProvider","$locationProvider",function(e,r){"use strict";e.when("/grains",{templateUrl:"partials/grains-list.html",controller:"SeedListCtrl"}).when("/grains/:seedId",{templateUrl:"partials/grains-detail.html",controller:"SeedDetailCtrl"}).when("/grains/meta/:seedId",{templateUrl:"partials/grains-meta.html",controller:"SeedDetailCtrl"}).otherwise({redirectTo:"/grains"}),r.hashPrefix("!")}]);var grainsControllers=angular.module("grainsControllers",[]);grainsControllers.controller("SeedListCtrl",["$scope","$http",function(e,r){"use strict";r.get("grains/index.json").success(function(r){e.seeds=r,e.seedsSlicesByThree=[];for(var t=0;t<e.seeds.length;)e.seedsSlicesByThree.push(e.seeds.slice(t,t+3)),t+=3})}]),grainsControllers.controller("SeedDetailCtrl",["$scope","$routeParams","$http",function(e,r,t){"use strict";e.seedId=r.seedId,t.get("grains/"+r.seedId+"/meta.json").success(function(r){e.seed=r}),e.getSeedUrl=function(){return"grains/"+e.seedId+"/index.html"}}]);
...
!function(){"use strict";for(var a,b=function(){},c=["assert","clear","count","debug","dir","dirxml","error","exception","group","groupCollapsed","groupEnd","info","log","markTimeline","profile","profileEnd","table","time","timeEnd","timeStamp","trace","warn"],d=c.length,e=window.console=window.console||{};d>0;)a=c[d],e[a]||(e[a]=b),d-=1}();var grainsApp=angular.module("grains",["ngRoute","grainsControllers"]);grainsApp.config(["$routeProvider","$locationProvider",function(a,b){"use strict";a.when("/grains",{templateUrl:"partials/grains-list.html",controller:"SeedListCtrl"}).when("/grains/:seedId",{templateUrl:"partials/grains-detail.html",controller:"SeedDetailCtrl"}).when("/grains/meta/:seedId",{templateUrl:"partials/grains-meta.html",controller:"SeedDetailCtrl"}).otherwise({redirectTo:"/grains"}),b.hashPrefix("!")}]);var grainsControllers=angular.module("grainsControllers",[]);grainsControllers.controller("SeedListCtrl",["$scope","$http",function(a,b){"use strict";b.get("grains/index.json").success(function(b){a.seeds=b,a.seedsSlicesByThree=[];for(var c=0;c<a.seeds.length;)a.seedsSlicesByThree.push(a.seeds.slice(c,c+3)),c+=3})}]),grainsControllers.controller("SeedDetailCtrl",["$scope","$routeParams","$http",function(a,b,c){"use strict";a.seedId=b.seedId,c.get("grains/"+b.seedId+"/meta.json").success(function(b){a.seed=b}),a.getSeedUrl=function(){return"grains/"+a.seedId+"/index.html"}}]);